...
CREATE TABLE `books` (
  ...
  `deweydecimal` varchar(45) NOT NULL,
...
INSERT INTO `meetingroombooking` VALUES (1,1,1234,1100,1200,'2017-07-06'),(2,2,4321,1400,1500,'2017-07-06'),(3,2,3421,1200,1300,'2017-07-06'),(4,1,5896,1100,1200,'2017-07-06'),(5,3,4785,1000,1100,'2017-07-06');
...
INSERT INTO `reviews` VALUES (1,1,'1',3,'Decent Book'),(2,2,'1',3,'Not the best book out there'),(3,3,'2',4,'GOT is amazing!'),(4,2,'3',5,'This is interesting!'),(5,1,'4',5,'WOW!!!!');
...
INSERT INTO `tags` VALUES (1,1,'survival'),(2,1,'dystopian'),(3,2,'fantasy'),(4,3,'fantasy'),(5,4,'fantasy'),(6,5,'surreal');
...
-- Dump completed on 2017-07-06  1:17:30
